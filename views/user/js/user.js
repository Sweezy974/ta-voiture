...
function pendingReservationList() {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      for (i = 0; i < data.Status.length; i++) {
        $('#pendingReservation').append('<li class="collection-item avatar grey lighten-3 "> <img src="views/base/img/rs6.jpg" alt="" class="circle"> <span class="title">nom</span> <p>détails <br> détails 2 </p> <a href="#!" class="secondary-content"><i class="material-icons">grade</i></a> </li>');
