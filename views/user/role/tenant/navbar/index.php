        ...
        <div class="nav-wrapper">
          ...
          <div class="col s12 m4 l3">
            <ul id="slide-out" class="side-nav fixed" style="transform: translateX(0%);">
              ...
              <li><a href="#"><!--<i class="material-icons right">mode_edit</i>!--> Nouvelle recherche</a></li>
              <li><a href="/?c=user&t=reservationList"><!--<i class="material-icons right">collections_bookmark</i>!-->Mes réservations</a></li>
